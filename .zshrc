...
alias o='open'
alias qq='exit'
alias vcf='cd ~/.config/nvim/ && v configs/02.setting.vim'
...
alias vpn="sudo openvpn --config ~/.config/openvpn/client/client.ovpn --auth-user-pass --auth-retry interact"

alias burp="cd ~/Burp/ && java -noverify -javaagent:BurpLoader.jar -jar burpsuite_pro.jar"
alias edit="nvim ~/.zshrc"
alias team="sudo warp-cli connect"
alias disteam="sudo warp-cli disconnect"
...
# TOOLS/dextra : for get string from dex
export PATH=$PATH:$HOME/TOOLS/dextra

## ruby 3.0 from Homebrew
# export PATH=$PATH:/usr/local/lib/ruby/gems/3.0.0/bin # by default, binaries installed by gem will be placed

# export PATH="/usr/local/opt/ruby/bin:$PATH"
# export LDFLAGS="-L/usr/local/opt/ruby/lib"
# export CPPFLAGS="-I/usr/local/opt/ruby/include"
## ruby 2.7 from Homebrew
export PATH="/usr/local/opt/ruby@2.7/bin:$PATH"
export LDFLAGS="-L/usr/local/opt/ruby@2.7/lib"
export CPPFLAGS="-I/usr/local/opt/ruby@2.7/include"
export PKG_CONFIG_PATH="/usr/local/opt/ruby@2.7/lib/pkgconfig"
export PATH="$HOME/TOOLS/polaris/bin/:$PATH"
#--------------------------GO LANG
...
#--------------------------class-dump
export PATH=$PATH:$HOME/TOOLS/class-dump/

#--------------------------class-dump-z
export PATH=$PATH:$HOME/TOOLS/class-dump-z
